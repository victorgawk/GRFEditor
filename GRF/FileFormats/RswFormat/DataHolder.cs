...
namespace GRF.FileFormats.RswFormat {
	public sealed class DataHolder {
		public static List<Utilities.Extension.Tuple<int, int, List<QuadTreeNode>>> QuadTrees = new List<Utilities.Extension.Tuple<int, int, List<QuadTreeNode>>>();
		...
		public static void AddQuadTree(int sizeX, int sizeY, List<QuadTreeNode> nodes) {
			QuadTrees.Add(new Utilities.Extension.Tuple<int, int, List<QuadTreeNode>>(sizeX, sizeY, nodes));
		}
	}
}
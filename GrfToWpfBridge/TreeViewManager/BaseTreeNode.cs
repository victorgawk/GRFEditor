...
namespace GrfToWpfBridge.TreeViewManager {
	public class BaseTreeNode {
		...
		public void UpdateDisplayEncoding() {
			...
			List<Utilities.Extension.Tuple<string, BaseTreeNode>> children = Children.ToList().Select(p => new Utilities.Extension.Tuple<string, BaseTreeNode>(p.Key, p.Value)).ToList();
